...
export const isNull = (type: Tspec.Type) => type.typeName === 'enum' && type.enums.length === 1 && type.enums[0] === null;
...
export const hasUndefined = (property: Tspec.Property): boolean => property.type.typeName === 'undefined' || (property.type.typeName === 'union' && property.type.types.some((type) => type.typeName === 'undefined'));
